...
Use the `Intro_to_Tidyverse.Rmd` as a guide in thinking about what can be done to your data.
...
3.  **Always start with the simplest approach that works well.** Then build on that.
