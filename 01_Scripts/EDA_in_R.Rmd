...
heatmap(corr_matrix, main = "Heatmap of Iris Correlations")
...
if(!dir.exists("02_HTML_files")) dir.create("02_HTML_files")

# Render HTML into that folder
rmarkdown::render(
  here("01_Scripts", "EDA_in_R.Rmd"),
  output_file = here("02_HTML_files", "EDA_in_R.html")
)
